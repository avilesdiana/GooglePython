...
def format_address(address_string):
  ...
  street_complete = address_string.split()
  # Traverse through the address parts
  for x in street_complete:
...
"""
 professor with two assistants, Jamie and Drew, wants an attendance list of the students, 
...
and each one collected responses into dictionaries, with names of their friends and how many guests each friend is bringing. 
